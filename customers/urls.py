...
urlpatterns = [
    ...
    path('api/features/', onboarding_views.list_create_features, name='feature-list'),
    path('api/subscription-plans/', onboarding_views.list_create_subscription_plans, name='subscription-plan-list'),

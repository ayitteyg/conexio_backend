"""
Django settings for conexio project.
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt',    # ✅ Optional, but fine to include
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",# Django backend
]
